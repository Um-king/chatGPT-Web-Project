...
- 문서 작업에 대한 다양한 경험
  ...
  - 프로젝트 개발보다 어려웠던 문서 작업을 직접 수행하여 유지보수에 자신감이 생겼다.

- 책임감 및 자신감
  - 단순히 미니 프로젝트 제출이 아닌 내 아이디어로 개발하고, 배포한다고 생각하니 책임감이 컸다.
  - 마감기간을 지키기 위해, 더 좋은 결과를 얻기 위해 노력했고 완벽하진 않지만 할 수 있다는 자신감이 생겼다. 
